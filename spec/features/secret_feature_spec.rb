...
# feature "secret features" do 
#   feature "Users personal secret page" do
#     scenario "shouldn't see other user's secrets"
#     scenario "create a new secret" 
#     scenario "destroy secret from profile page, redirects to user profile page"   
#   end
#   feature "Secret Dashboard" do 
#     scenario "displays everyone's secrets"
#     scenario "destroy secret from index page, redirects to user profile page"   
#   end
# end