...
# feature 'Like Features' do
#   feature 'secret has not been liked' do  
#     scenario "like count updated correctly" 
#     scenario "displays like button if you haven't liked secret"
#     scenario "liking will update like count, like button not visible"
#   end
#   feature "secret has been liked" do    
#     scenario "unlike button is visible"
#     scenario "unliking will update like count"
#   end
# end